        ...
        <div className="flex-1 flex items-start md:justify-end gap-20">
          <div>
            ...
            <ul className="text-sm space-y-2">
              ...
              {/* LinkedIn - second */}
              <li>
                <a href="https://www.linkedin.com/feed/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-blue-600">
                  <img 
              ...
              {/* Instagram */}
              <li>
                <a href="https://www.instagram.com/viishallgupta" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-pink-500">
                  <img 
              ...
              {/* TRCAC College - Inline SVG */}
              <li>
                <a href="https://www.trcac.org.in/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-600">
          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-2 pt-4">
                <input className="border border-gray-500/30 placeholder-gray-500 focus:ring-2 ring-indigo-600 outline-none w-full max-w-64 h-9 rounded px-2" type="email" placeholder="Enter Your Active Email to Join" />
